...
class PdfConverterTest {
    ...
    private PdfConverter newPdfConverter() {
        return new PdfConverter(pdfExporterPolarionService, headerFooterSettings, cssSettings, placeholderProcessor, velocityEvaluator, coverPageProcessor, weasyPrintServiceConnector, htmlProcessor, pdfTemplateProcessor, bulkProcessingConnector);
    }
