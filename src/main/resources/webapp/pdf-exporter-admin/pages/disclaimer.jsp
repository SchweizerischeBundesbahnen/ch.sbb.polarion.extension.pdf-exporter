    ...
    <div>
        <article class="markdown-body">
            <%
                ...
                try (InputStream inputStream = ExtensionInfo.class.getResourceAsStream("/webapp/" + extensionContext + "-admin/html/disclaimer.html")) {
                    if (inputStream != null) {
                        out.println(new String(inputStream.readAllBytes(), StandardCharsets.UTF_8));
                    } else {
                        out.println("No disclaimer has been generated during build. Please check <a href=\"" + version.getProjectURL() + "/DISCLAIMER.md\" target=\"_blank\">the online documentation</a>.");
                    }
                }
            %>
        </article>
