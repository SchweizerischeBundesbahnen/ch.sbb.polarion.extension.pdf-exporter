...
public class BulkPdfExportTableRenderer extends AbstractWidgetRenderer {
    @NotNull
    ...
    public BulkPdfExportTableRenderer(@NotNull RichPageWidgetCommonContext context) {
        super(context);
    ...
    protected void render(@NotNull HtmlFragmentBuilder builder) {
        if (this.topItems < 0) {
            ...
            exportItems.attributes().className("table export-items");
